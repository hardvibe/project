    ...
    <div className='w-[1312px] h-[877px] mt-24 opacity-44 rounded-[32px] bg-[#E8E6D9]'>
      <div className='flex justify-between items-center w-[1216px] ml-12 mt-9'>
        ...
        <div className='flex justify-between w-[507px]'>
          <button className='mt-[9px]'><img src='/Images/logo1.png'/></button>
          <button className='mt-[11px]'><img src='/Images/logo2.png'/></button>
          <button><img src='/Images/logo3.png'/></button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-[480px_394px_288px] gap-4 w-[1216px] h-[576px] mt-12 ml-12">
        ...
        <iframe 
          width="480" 
          height="336" 
          src="https://www.youtube.com/embed/dQw4w9WgXcQ?si=1CTjRhl-FV4oQpTD" ></iframe>
      </div>
          <div className="grid grid-cols-2 gap-4">
            <div className="w-[232px] h-[224px] bg-[url('/Images/2.png')]"></div>
            <div className="w-[232px] h-[224px] bg-[url('/Images/3.png')]"></div>
          </div>
        </div>
        <div className="h-[576px] bg-[url('/Images/4.png')] "></div>
        <div className="flex flex-col gap-4">
          <div className="h-[280px] bg-[url('/Images/5.png')]"></div>
          <div className="h-[280px] bg-[url('/Images/6.png')]"></div>
        </div>
      </div>
